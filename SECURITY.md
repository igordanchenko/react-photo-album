...
Thank you for helping keep `react-photo-album` and its users safe.
...
[private vulnerability reporting](https://github.com/igordanchenko/react-photo-album/security/advisories/new).
...
`[react-photo-album] security report`.
